...
import com.stackroute.authentication.controller.UserController;
...
public class UserControllerTest {
	...
	public void testRegisterUser() throws Exception {
		...
		mockMvc.perform(post("/api/v1/userservice/register").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
